...
const ProfileEditModal: FC<Props> = ({ setOpenModal }) => {
    ...
    return (
    <div ref={overlay} className="fixed top-0 flexCenter w-full h-screen bg-black/80" onClick={onClick}>
      <form className="flex flex-col bg-white lg:w-1/3 h-fit rounded-xl p-8">
          <h3 className="text-[32px] leading-[38px] font-bold">Add your socials</h3>
          <label htmlFor="github" className="text-small pt-9">GitHub</label>
          <input
              type="text"
              id="github"
          ...
          />
          <label htmlFor="linkedin" className="text-small pt-9">LinkedIn</label>
          <input
              type="text"
              id="github"
